# Dr Shivanand Hosamani Clinic — Website (Sindagi)

- **Live:** https://shreekantha3.github.io/sindagi-dr-shivanand-hosamani-clinic/
- **Repo:** `shreekantha3/sindagi-dr-shivanand-hosamani-clinic` (branch `main` = source, `gh-pages` = deployed bundle where applicable)
- **Stack:** static Vite + Tailwind CSS, no backend. `base: '/sindagi-dr-shivanand-hosamani-clinic/'` for GitHub Pages project-site hosting.
